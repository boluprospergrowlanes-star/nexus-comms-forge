...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nexus Discord Solutions — Building Professional Discord Communities" },
      { name: "description", content: "Nexus Discord Solutions (NDS) designs, builds, secures and manages professional Discord communities for creators, gaming, Web3 and businesses." },
      { name: "author", content: "Nexus Discord Solutions" },
      { property: "og:title", content: "Nexus Discord Solutions" },
      { property: "og:description", content: "Secure. Organized. Automated. Premium Discord server & bot development agency." },
